...
namespace LanchesMac.Models
{
    public class Lanche
    {
        ...
        public Lanche(int id, string nome, string descricaoCurta, string descricaoDetalhada, decimal preco, string imagemUrl, string imagemThumbnailUrl, bool isLanchePreferido, bool emEstoque, Categoria categoria)
        {
            Id = id;
            Nome = nome;
